...
- และโดยสถิติแล้ว งานมักจะเข้าช่วง 17:00 เวลาไทย (งานเข้าก็เช่น เคสมา / เจอบั๊ค report / เจอแก้งานด่วน) ซึ่งนั่นเป็นช่วง 20:00 เวลาที่นี่ บางทีกำลังทำข้าวเย็นหรือกินข้าวอยู่ดีๆ ทีมฝั่งไทย reach out ขอความช่วยเหลือมาจ้า
...
แต่ทั้งหมดที่เล่าๆ มาส่วนนึงที่จะยังทำให้งาน keep momentum และเดินหน้าต่อไปได้ ก็คือมีทีมงานที่ดีนี่แหละ (ต้องขอบคุณทีม dev สาขาประเทศไทยที่ช่วยให้งานไหลลื่น และแก้เคสบางอย่างเป็นด่านหน้าให้นะครัช)

ส่วนคำตอบของคำถามที่ว่าทำงานที่ไหนนั้น เราได้มาทำงานอยู่ที่ **QUT (Queensland University of Technology) Creative Enterprise Australia** (ตัวย่อ: QUTCEA) ซึ่ง QUTCEA เองก็เหมือนเป็นหน่วยงานภายใต้ QUT อีกที โดยโฟกัสที่ช่วยเหลือ local business หรือ startup ในละแวกนี้ให้โตขึ้นครับ
...
- **ใช้ห้องสมุดได้:** ยืมหนังสือก็ได้เหมือนกันนะเออ
...
ส่วนของรถสาธารณะนั้น ที่นี่ก็จะมีรถเมล์ / รถไฟ / รถราง ซึ่งทั้งหมดนั้นให้บริการโดยเจ้าเดียวกันหมดเลย (ชื่อ Translink) โดยเราต้องซื้อบัตร GoCard มา โดยมีค่าออกบัตร A$10 ข้อดีของเจ้า GoCard ก็คือ บัตรเดียวเอาอยู่ทุกอย่างทั้งรถเมล์และรถไฟ และอีกหนึ่งความเจ๋งคือ ถ้าเราต่อรถเมล์หรือรถไฟไปอีกสายนึง ระบบมันจะคิดเงินใหม่ให้ ซึ่งถ้าสมมติมันอยู่ใน zone คิดราคาเดียวกัน มันจะไม่ตัดตังเพิ่ม พูดง่ายๆ คือยิ่งต่อรถเยอะๆ สุดท้ายมันจะ optimize ราคาให้
...
แถมอีกอย่างนึงคือ ระบบขนส่งสาธารณะมันค่อนข้างพาเราไปได้หลากหลายจุดทั่วเมืองจริงๆ เหมือนวางแปลนมาอย่างดี อย่างวันก่อนไป Gold Coast ซึ่งไกลเอาการ แต่ก็สามารถเดินทางด้วยรถไฟ / รถราง / รถเมล์ ไปจนถึงได้เลย พูดง่ายๆ คือมึงสามารถไปไหนก็ได้ในเมือง ถ้าไม่ consider เรื่องเวลา
...
แต่ที่ออสเตรเลีย อาหารค่อนข้างมีความ diversity สูงระดับนึงนะ ถึงแม้จะไม่เท่าไทย ก็มีทั้งอาหารฝรั่ง / อเมริกา / ญี่ปุ่น (ซึ่งความแปลกคือ ที่นี่คนเกาหลีอะเยอะมากๆ แต่คนเกาหลีมันไม่ทำอาหารเกาหลีขายเว้ย แม่งทำอาหารญี่ปุ่นขาย) / เกาหลี / จีน / เวียดนาม / แม็กซิกัน / ไทย คืออ่านๆ ดูแล้วก็บอกว่ามันก็หลากหลายอยู่นิ แต่ขอบอกเลยว่าไทยเราหลากหลายกว่านั้นเยอะมากๆๆๆๆๆ
...
![กาแฟ A$5.5 แต่อร่อยมาก กินบ่อยมากร้านนี้ 5555](./12.jpg)
...
- ทางม้าลาย โคตรศักดิ์สิทธิ์ คือถ้ามีคนข้ามอยู่ ไม่ว่ารถมึงจะใหญ่ขนาดนั้นมึงจะหยุดให้คนข้ามเสมอ
...
- จริงๆ หลักการรถหยุดให้คนข้าม apply ไปถึงรถบนท้องถนนกันเองด้วย ใช้หลักการว่ารถใหญ่รอรถเล็ก (รถยนต์ รอจักรยาน / รถบัส รอรถยนต์)
- โซนที่อยู่กับทำงาน มีความเป็นภูเขาสูงมาก คือทางชันมาก จะเจอเหตุการณ์ที่ว่า Google Maps พาเดินก็ดูจะไม่มีอะไรนิ แต่ความเป็นจริงไอ้ทางที่มึงมาพากูเดินคือชันมากๆ เข่าพังชิบหายวายวอด 555 และเอาเข้าจริง Google Maps มันมีฟีเจอร์บอกความชัน แต่ในไทยแม่งไม่เคยใช้ไง 55555
...
- รถเมล์ที่นี่มีเลนถนนให้รถเมล์โดยเฉพาะด้วยบางสาย และมีแม้กระทั่งอุโมงค์ให้รถเมล์ขับเท่านั้นด้วย เพื่อให้มันไม่ไปรบกวนถนนหลักมาก
